---
layout: post
title:  How to Properly Sharpen a Knife
...
There's something incredibly satisfying about the art of knife sharpening. After a long day's work, I love nothing more than cracking a cold one and putting an edge on a knife while jamming to my favorite country tunes. Trust me, it's a rejuvenating experience you should definitely try!

There's nothing more frustrating than struggling with a dull knife in the kitchen or grappling with a poorly maintained pocket knife when you need it most. Sharpening knives is a fundamental life skill, yet most people have no clue about how to do it.

In this post, I'd like to share with you the proper way to sharpen a knife. I'll not only show you _how_ to achieve a reliable working edge suitable for nearly all everyday tasks but also explain _why_ each step is crucial. Let's dive in!

## The Tools

Forget about fancy sharpening jigs. Why?

> **Reason #1:** While these tools can be effective, they often only sharpen what's called the _primary edge_ of your knife, which limits your ability to create a well-defined edge as your knife ages. You might be wondering what the hell a primary edge is. Let's clarify by looking at how a cutting tool works.

At its core, a knife blade is a tool that's designed to separate materials, be it steak, vegetables, rope, or cardboard. When you insert the edge into an object and guide it along a cutting line, the knife effectively divides that object.
...
- The **secondary edge** runs from the top or middle of the knife down to the edge of the blade, defining its overall cutting profile;
- The **primary edge,** on the other hand, is a finer angle located right at the edge of the blade. Ground on top of the secondary edge, it sharpens the blade for optimal cutting performance.
...
> **Reason #2:** Sharpening jigs operate with fixed angles, which restricts your ability to customize and fine-tune your primary edge to meet your specific needs.

Different tasks require different primary edge angles. Generally, wider angles tend to wear down more slowly than narrower ones, making them better suited for rugged use. If you intend to beat the crap out of your knife and put it through tough situations, say cutting against concrete or rocks, opting for a wider primary edge angle can help maintain its edge longer.

Conversely, if your primary uses involve tasks like slicing fruit, preparing meals, or opening Amazon packages, you'll benefit from sharpening to narrower primary edge angles. These angles enhance cutting ability, allowing for more precise and effortless slicing. Ultimately, choosing the right angle depends on how you plan to use your knife, balancing durability with performance based on your specific needs.

Using a jig limits you to preset angles that may not align with the specific edge you want to achieve. Additionally, as you improve your sharpening skills, you might want to experiment with different angles and bevel configurations, something a jig simply can't provide.

> **Reason #3:** While it may sound a bit subjective and philosophical, <a href="https://youtu.be/cJMwBwFj5nQ" target="blank">perhaps even something Bruce Lee would say,</a> sharpening is a deeply personal experience. When you sharpen a blade, you forge a connection with it, you become one with that blade, it's your hands that put the edge on it afterall. This knife may very well outlive you, so why delegate its maintenance to a mechanical device? Embrace the process and do it yourself.

That said, all you really need to sharpen a knife is a quality whetstone. A basic one from your local hardware store will do. While the learning curve for sharpening with a whetstone may be steeper, the skills you gain will pay off in the long run, giving you custom edges that perfectly fit your needs and greater satisfaction.
...
### Thinning the Secondary Edge

We've been discussing the significance of the secondary edge in cutting performance, so it's no surprise that the first step in sharpening a knife is to thin it. However, this isn't always necessary. You only need to do this if you notice that your secondary edge is too obtuse and you want to enhance the blade's cutting ability by thinning it behind the edge.

>**_A word of caution: keep in mind that thinning the secondary edge unnecessarily will shorten your knife's lifespan. This step is only necessary for worn out knives, particularly when you notice that their cutting ability has declined due to extended sharpening over time. In certain situations, thinning can also be beneficial for new knives, but this should only be done if you know exactly what you're doing and why you're doing it._**
...
As you progress, gently lift the hand holding the knife handle while slightly twisting it outward to accommodate variations in the tip angle:
...
At this point, you should have a knife with a sufficiently sharp working edge that will perform well in everyday tasks. We can enhance this edge further by stropping it. 
...
As mentioned earlier, we've now transitioned between steps, moving from grinding the primary edge to stropping, so we should increase our diligence once more. Furthermore, while stropping, it's important to apply no pressure at all: simply glide the knife along the surface of the whetstone. Strop both sides of the blade evenly, aiming for about 10 glides on each side. This should be sufficient to refine the edge while keeping its angularity. 
...
To test the sharpness of your knife after finishing, use the classic paper testing method: hold the paper vertically and angle the blade toward it. If the knife is properly sharpened, it should cut effortlessly through the paper. 
...
There are various ways to sharpen a knife, and I encourage you to experiment to find what suits you best. Don't just take my word for it: do your own research and hands on experimenting. 

I recommend checking out these two videos by Master Bladesmith Murray Carter:

- <a href="https://www.youtube.com/watch?v=Yk3IcKUtp8U" target="blank">Blade Sharpening Fundamentals</a>
- <a href="https://www.youtube.com/watch?v=_AZiOWF-QXM" target="blank">Advanced Blade Sharpening Fundamentals</a>

And if you speak Portuguese, make sure to explore <a href="https://www.youtube.com/watch?v=dJfVo0Upy6U&list=PLJW-OHs28_I_1aEXiaoKVFeHge433cQQD&pp=iAQB" target="blank">this playlist</a> by Dr. Hélio Cabral Júnior.

These experts have a wealth of knowledge about sharpening, and I've learned a lot from them. While I've picked up some skills, I'm not nearly as proficient as they are, and they excel at teaching their craft.

So dive in with persistence and patience, learn as much as you can and remember, you don't need to spend a fortune on equipment to achieve a sharp, reliable working edge. Your own hands on testing and experimenting will eventually lead you to your perfect process and results. Be patient and enjoy the journey. Every edge you put on a knife brings you closer to mastery.
